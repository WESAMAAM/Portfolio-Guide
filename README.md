...
| Power BI for Data Analytics | Sept 2026 | Power BI, Power Query, DAX, Data Modeling | I completed a comprehensive training in Power BI, mastering the complete data analytics workflow. I learned how to extract and clean messy data using Power Query (ETL) and structure it efficiently using Data Modeling (Star Schemas). To dig deeper into the data, I acquired strong skills in DAX, writing custom formulas for complex calculations. Finally, I brought it all together by designing interactive, user-friendly dashboards in Power BI. |
|  |  |  |  |
